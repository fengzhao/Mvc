...
namespace Microsoft.AspNetCore.Mvc.TagHelpers.Cache
{
    ...
    public class HybridHtmlFragmentCache : IHtmlFragmentCache
    {
        ...
        public async Task<IHtmlContent> SetDistributedAsync(string key, Func<Task<IHtmlContent>> renderContent, HtmlFragmentCacheContext context, IDistributedCache cache)
        {
        ...
        public bool GetMemoryValue(string key, out IHtmlContent value)
        {
            return _memoryCache.TryGetValue(key, out value);
        }

        public async Task<IHtmlContent> GetDistributedValueAsync(string key, IDistributedCache cache)
        {
